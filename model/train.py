...
Full training requires access to the discovery cohort dataset
(GSA-Human accession: HRA014933) and is not intended to be executed
...
if __name__ == '__main__':
    ...
    # Full dataset available at GSA-Human accession: HRA014933
    ...
    for fold in range(1, 6):
        run_training(
            ...
            learning_rate  = 5e-5,
            weight_decay   = 0.01,
            patience       = 100,       # conservative setting; early stopping rarely triggered
